...
const experience = [
{
  ...
  description: [
  'Created wireframes, prototypes, and high-fidelity mockups for web applications.',
  'Conducted user research and usability testing to improve product flows.',
  'Collaborated closely with developers to ship accurate, polished designs.']
              ...
              <div className="space-y-4">
                ...
                <FadeIn
                  ...
                  className="bg-background p-6 rounded-2xl border border-border hover:border-accent/50 transition-colors">
                    ...
                    <p className="text-sm text-subtle mb-3">{edu.institute}</p>
